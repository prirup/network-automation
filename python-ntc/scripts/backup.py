...
with open("/home/ntc/network-automation/python-ntc/files/configs/csr1.cfg", "w") as config_file:
...
with open("/home/ntc/network-automation/python-ntc/files/configs//csr2.cfg", "w") as config_file:
